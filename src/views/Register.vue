      ...
      <div class="church-card auth-card">
        <div class="card-body p-4 p-lg-5">
          <div class="text-center mb-4">
            ...
            <p style="color: var(--dark-light);">Create your account and stay connected</p>
          </div>
          ...
          <p class="text-center mb-0" style="font-size: 0.9rem; color: var(--dark-light);">
            ...
            <router-link to="/login" class="fw-semibold" style="color: var(--gold-dark);">
              Sign in here
            </router-link>
          </p>
        </div>
...
async function handleRegister() {
  ...
  loading.value = true;
  try {
    await userStore.signUpWithEmail(email.value, password.value, displayName.value);
    router.push("/");
  } catch (err) {
    const code = err.code || "";
