      ...
      <footer class="church-footer">
        <div class="container py-5">
          <div class="row g-4">
            <div class="col-md-4">
              ...
              >
                <i class="bi bi-cross me-2"></i>GKI Menteng
              </h5>
            ...
            <div class="col-md-4">
              ...
              <ul class="list-unstyled mb-0" style="font-size: 0.9rem">
                <li class="mb-2">
                  ...
                  <a href="#">Jl. Latuharhary No.7, Jakarta</a>
                </li>
                <li class="mb-2">
                  <i class="bi bi-telephone me-2" style="color: var(--gold)"></i>
                  <a href="tel:+62213924182">(021) 3924182</a>
                </li>
                <li class="mb-2">
                  <i class="bi bi-envelope me-2" style="color: var(--gold)"></i>
                  <a href="mailto:gkimenteng7@gmail.com">gkimenteng7@gmail.com</a>
                </li>
              </ul>
            </div>
            <div class="col-md-4">
        ...
        <div class="text-center py-3" style="border-top: 1px solid rgba(201, 168, 76, 0.2)">
          <p class="mb-0" style="color: rgba(245, 240, 232, 0.6); font-size: 0.85rem">
            &copy; {{ new Date().getFullYear() }} GKI Menteng. All rights reserved.
          </p>
        </div>
      </footer>
    </template>
