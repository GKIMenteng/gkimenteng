  ...
  <div id="app">
    <nav class="navbar navbar-expand-lg navbar-church sticky-top" ref="navbar">
      <div class="container">
        <router-link class="navbar-brand d-flex align-items-center" to="/">
          <i class="bi bi-cross me-2 fs-4"></i>
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              ...
              >
                ...
                <span class="d-lg-inline">Profile</span>
              </router-link>
            </li>
          </ul>
        </div>
    ...
    <footer class="church-footer">
      <div class="container py-5">
        <div class="row g-4">
          <div class="col-md-4">
            <h5 class="d-flex align-items-center mb-3" style="color: var(--gold); font-family: var(--font-heading);">
          ...
          <div class="col-md-4">
            <h6 class="mb-3" style="color: var(--gold); font-family: var(--font-heading);">Connect</h6>
          ...
          <div class="col-md-4">
            <h6 class="mb-3" style="color: var(--gold); font-family: var(--font-heading);">Follow Us</h6>
